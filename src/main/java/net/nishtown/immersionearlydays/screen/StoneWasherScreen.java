...
public class StoneWasherScreen extends AbstractContainerScreen<StoneWasherMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(ImmersionEarlyDays.MOD_ID, "textures/gui/stone_washer_gui2.png");


    public StoneWasherScreen(StoneWasherMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
